...
public class EurekaClinicalUserAgreementClientProvider implements Provider<EurekaClinicalUserAgreementClient> {
    ...
    private final String userAgreementServiceUrl;

    public EurekaClinicalUserAgreementClientProvider(String inUserAgreementServiceUrl) {
        this.userAgreementServiceUrl = inUserAgreementServiceUrl;
    }

    @Override
    public EurekaClinicalUserAgreementClient get() {
        return new EurekaClinicalUserAgreementClient(this.userAgreementServiceUrl);
    }
